...
export const conditions: Condition[] = [
  {
    ...
    slug: "blebitis",
    category: "Glaucoma",
    description: "Blebitis is an infection of the filtering bleb, a small blister-like fluid collection created during glaucoma surgery (trabeculectomy). It causes the eye to become red, painful, and sensitive to light. Immediate treatment is required to prevent the infection from spreading into the eye (endophthalmitis).",
    symptoms: ["Redness (especially over the bleb)", "Eye pain", "Sensitivity to light", "Blurred vision", "Discharge"],
    treatments: ["Intensive topical antibiotics", "Oral antibiotics", "Close monitoring", "Hospitalization (in severe cases)"],
    seoTitle: "Blebitis Treatment Orange County | Glaucoma Surgery Complication",
    seoDescription: "Urgent treatment for Blebitis in Orange County. Infection of the glaucoma filtration bleb requires immediate care. Call (949) 364-0008.",
    localKeywords: ["blebitis treatment", "infected trabeculectomy bleb", "glaucoma surgery infection", "eye emergency orange county"],
    relatedServices: ["Glaucoma Management", "Emergency Eye Care"]
  },
  // Corneal Conditions
  {
    name: "Keratoconus",
